#!/usr/bin/env python3
"""PUMP binding for the shared frozen TranAD detection implementation."""
...
OUTPUT_ROOT = ROOT / "results" / "PUMP_TRANAD_RESULTS"
...
def configure() -> None:
    ...
    runner.CHECKPOINT_PATH = (
        runner.CHECKPOINT_ROOT / "TranAD_PUMP_state_dict.pt"
    )
    ...
    runner.LABEL_PATH = ROOT / "dataset" / "PUMP" / "PUMP_test_label.npy"
    runner.DATASET_NAME = "PUMP"
    runner.EXPECTED_TRAIN_POINTS = 17155
    runner.EXPECTED_TEST_POINTS = 203165
    runner.TranADPSMDataAdapter = TranADPUMPDataAdapter
    runner.load_tranad_psm_config = load_tranad_pump_config
