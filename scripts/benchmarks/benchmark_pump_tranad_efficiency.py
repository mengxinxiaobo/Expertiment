#!/usr/bin/env python3
"""PUMP binding for the shared TranAD inference-efficiency benchmark."""
...
RESULT_ROOT = ROOT / "results" / "PUMP_TRANAD_RESULTS"
...
def configure() -> None:
    ...
    if not detection_protocol_path.is_file():
        raise FileNotFoundError(
            "Run the formal PUMP TranAD detection experiment before efficiency"
        )
    ...
    benchmark.EXPECTED_TEST_POINTS = 203165
    benchmark.DATASET_NAME = "PUMP"
    benchmark.WINDOW = 10
    benchmark.INPUT_C = 51
    benchmark.EXPECTED_PARAMETERS = 225519
    benchmark.TranADPSMDataAdapter = TranADPUMPDataAdapter
    benchmark.load_tranad_psm_config = load_tranad_pump_config
