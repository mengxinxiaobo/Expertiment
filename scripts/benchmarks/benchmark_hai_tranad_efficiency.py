#!/usr/bin/env python3
"""HAI binding for the shared TranAD inference-efficiency benchmark."""
...
RESULT_ROOT = ROOT / "results" / "HAI_TRANAD_RESULTS"
...
def configure() -> None:
    ...
    if not detection_protocol_path.is_file():
        raise FileNotFoundError(
            "Run the formal HAI TranAD detection experiment before efficiency"
        )
    ...
    benchmark.EXPECTED_TEST_POINTS = 284400
    benchmark.DATASET_NAME = "HAI"
    benchmark.WINDOW = 10
    benchmark.INPUT_C = 86
    benchmark.EXPECTED_PARAMETERS = 627074
    benchmark.TranADPSMDataAdapter = TranADHAIDataAdapter
    benchmark.load_tranad_psm_config = load_tranad_hai_config
